...
while(True):
    ...
    for(x,y,w,h) in rostro:
       ...
       ##Vamos a escribir en la ruta 
        cv2.imwrite("C:/Users/Ramses Moreno/Documents/GitHub/Proyecto_Desarrollo_Proyectos_inteligentes/face_recognitionOpenCv2-master/images/Ramses/data"+str(count)+".jpg", grises[y:y+h, x:x+w])
